...
- current pass turns the hero proof/profile area into one aligned support band, makes case details full-width and compact in STAR-style blocks, renames case surface "problem" labels to "task", and tightens profit, operating-model, and data-platform copy;
