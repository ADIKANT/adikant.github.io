    ...
    groups: [
      {
        ...
        items: [
          ...
          { value: "~300 млн ₽", label: "годовая экономия в Atom по внутренней оценке" },
      ...
      },
      {
        ...
        items: [
          ...
          { value: "180", label: "задач поступило в контур аналитики" },
          { value: "150", label: "реализовано" },
          { value: "82%", label: "доля завершенных задач", tone: "success" }
        ]
      }
    ]
  },
  ...
  cases: {
    ...
    items: [
        ...
        details: [
          ...
          },
          {
            ...
            list: [
              ...
              "Выстроил взаимодействие с 30+ бизнес-командами: discovery, delivery, демо, поддержка и развитие использования BI."
            ]
          },
          {
            title: "Result",
      ...
      },
      {
        ...
        problem:
          "Разным стейкхолдерам нужен был зрелый и прозрачный процесс: понятный вход, приоритеты, сроки, качество результата и поддержка после релиза.",
        role:
          "Координировал поток запросов совместно с командой и выстроил delivery-модель в контуре функции.",
        businessResult: "",
        businessResultMetrics: ["180 задач", "150 реализовано", "82% завершено"],
        metrics: [],
        details: [
          {
            title: "Situation",
          ...
          },
          {
            title: "Actions",
            list: [
              "Intake: фиксировали owner, бизнес-контекст, ожидаемое решение, критерии успеха и связь с управленческим действием.",
          ...
          },
          {
            title: "Result",
            body:
              "Delivery-контур помог автоматизировать 1000+ часов ручной работы в месяц и дал около 300 млн ₽ годовой экономии по внутренней оценке."
          }
        ],
        safeVisual: {
          type: "flow",
  ...
  profitEfficiency: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          "Прозрачные метрики, QA и регулярный контроль помогают раньше увидеть отклонения, спорные расчеты и зоны без ownership."
      },
      {
    ...
    surface: [
      {
        title: "Бизнес-вход",
        body:
          "Фиксирую owner, вопрос, ожидаемое действие и критерий успеха до старта разработки."
      },
      {
        title: "Управляемый delivery",
        body:
          "Перевожу спрос в backlog, RICE, S2T, QA и release с понятными trade-offs."
      },
      {
    ...
    steps: [
      {
        ...
        title: "Intake",
        body:
          "Фиксирую owner, бизнес-контекст, ожидаемое решение и критерий успеха.",
        points: ["owner и заказчик", "бизнес-контекст", "критерий успеха"]
      },
      {
        step: "02",
    ...
    items: [
      {
        ...
        body:
          "Есть потребность в управленческой отчетности, метриках, ownership, roadmap и регулярном использовании данных, но функция еще не собрана."
      },
      {
