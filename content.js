window.PORTFOLIO_CONTENT = {
    ...
    items: [
      {
        ...
        problem:
          "Бизнесу требовались единые правила расчета метрик, понятная точка входа в аналитику и регулярная отчетность для принятия решений.",
        role:
      ...
      },
      {
        ...
        details: [
          ...
          },
          {
            ...
            list: [
              ...
              "Build: data analysts совместно с командой переводили постановку в витрину, dashboard-сценарий, интеграцию или аналитический сервис.",
              "QA и release: проверяли расчеты, сценарии использования, доступы и соответствие ожиданиям заказчика.",
              "Support: после релиза проводили демо, описывали метрики и сопровождали пользователей.",
        ...
        safeVisual: {
          type: "flow",
          label: "Delivery path",
          items: ["Intake", "RICE", "S2T", "Build", "QA", "Release", "Support", "Self-service"]
        }
      },
      {
        company: "Mars",
  ...
  profitEfficiency: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          "Повторяемые отчеты и сверки перевожу в витрины, дашборды и self-service, чтобы команда тратила время на решения и сложные задачи."
      },
      {
        title: "Снижение рисков",
        body:
          "Прозрачные метрики, QA и регулярный контроль помогают раньше увидеть отклонения, спорные расчеты и зоны без ответственного."
      },
      {
        title: "Ускорение решений",
        body:
          "Руководители получают слой отчетности, где видно, что происходит, почему это важно и какое действие нужно дальше."
      },
      {
        title: "Self-service",
        body:
          "Бизнес получает самостоятельный доступ к типовым вопросам, а BI-команда освобождается для развития метрик и качества данных."
      }
    ]
  },
  ...
  managementScope: {
    ...
    items: [
      ...
      },
      {
        ...
        items: ["Требования к данным", "Качество, доступы и SLA", "Handoff с data engineering"]
      }
    ]
  },
    ...
    surface: [
      {
        title: "Бизнес-вход",
        body:
          "Фиксирую ответственного со стороны бизнеса, управленческий вопрос, ожидаемые действия и критерии результата до старта разработки."
      },
      {
      ...
      },
      {
        ...
        body:
          "Довожу решение до работы в бизнесе: демо, метрики, support и self-service."
      }
    ],
    steps: [
      {
        ...
        title: "Intake",
        body:
          "Фиксирую ответственного со стороны бизнеса, контекст, ожидаемое решение и критерии результата.",
        points: ["ответственный и заказчик", "бизнес-контекст", "критерии результата"]
      },
      {
        step: "02",
      ...
      },
      {
        ...
        title: "Build",
        body:
          "Провожу задачу через витрины, BI-слой, ревью и подготовку к использованию.",
      ...
      },
      {
        ...
        title: "QA / release",
        body:
          "Проверяю расчеты, сценарии, доступы, риски релиза и соответствие ожиданиям заказчика.",
        points: ["расчеты", "доступы", "риски релиза"]
      },
      {
        step: "07",
        title: "Support",
        body:
          "Делаю демо, описываю метрики, обучаю пользователей и отслеживаю использование.",
        points: ["демо", "описание метрик", "поддержка пользователей"]
      },
      {
        step: "08",
        title: "Self-service",
  ...
  techContext: {
    ...
    surface: [
      ...
      "понятный handoff с data engineering"
    ],
    items: [
      {
        title: "BI-слой",
